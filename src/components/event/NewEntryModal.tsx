...
export function NewEntryModal({ show, eventId, onClose, onSuccess }: NewEntryModalProps) {
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">Crea un nuovo tipo di ingresso per l'evento</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {formData.gender_min_enabled && (
              <div className="space-y-3 pl-4 border-l-2 border-[#FC0045]/30">
                {/* Tipo Genere */}
                <div>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-lg space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#FC0045] text-sm"
                  />
                </div>
